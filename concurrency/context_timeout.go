...
func queryShardTwo(ctx context.Context, query string, shard int, shardRes chan<- string) {
...
func ContextConcurrencyTimeout() {
	var g errgroup.Group

	bgctx := context.Background()
	ctx, cancel := context.WithTimeout(bgctx, time.Second*2)
